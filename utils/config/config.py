...
class EmojisDict:
    ...
    SYMBOL_PACK_1_NEON_EMOJIS = dict(zip(Roles.symbol_pack_1_neon, Emojis.symbol_pack_1_neon))
...
emoji_help_menu = {
    "nfl": [
        ...
        {"name": "nflneon", "desc": f"{EmojisDict.NFL_NEON_EMOJIS['New Orleans Saints']} - 32"},
        {"name": "nflneon2", "desc": f"{EmojisDict.NFL_NEON2_EMOJIS['New Orleans Saints']} - 32"},
        {
            "name": "nflhelmet",
            "desc": f"{EmojisDict.NFL_HELMET_EMOJIS['New Orleans Saints']} - 32",
        },
        {"name": "nfl3d", "desc": f"{EmojisDict.NFL_3D_EMOJIS['New Orleans Saints']} - 32"},
        {"name": "nfllogos", "desc": f"{EmojisDict.NFL_LOGOS_EMOJIS['NFL']} - 8"},
    ],
    "nba": [
        {"name": "nba", "desc": f"{EmojisDict.NBA_EMOJIS['Los Angeles Clippers']} - 30"},
    ...
    "college": [
        {"name": "college", "desc": f"{EmojisDict.COLLEGE_EMOJIS['Clemson Tigers']} - 32"},
        {
            "name": "collegehelmet",
        ...
        {"name": "collegelogos", "desc": f"{EmojisDict.COLLEGE_LOGOS_EMOJIS['NCAA']} - 7"},
    ],
    "media": [
        {"name": "media", "desc": f"{EmojisDict.MEDIA_EMOJIS['Fox']} - 14"},
        {"name": "devtraits", "desc": f"{EmojisDict.DEVTRAITS_EMOJIS['Super Star X Factor']} - 5"},
        {"name": "symbolpack1", "desc": f"{EmojisDict.SYMBOL_PACK_1_EMOJIS['Info']} - 4"},
        {
    ...
    "other": [
        ...
        {"name": "usfl", "desc": f"{EmojisDict.USFL_EMOJIS['New Orleans Breakers']} - 8"},
