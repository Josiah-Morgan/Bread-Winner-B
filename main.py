...
class Bread(commands.AutoShardedInteractionBot):
    def __init__(self):
        super().__init__(intents=intents, activity=disnake.Game(name="nothing"), allowed_mentions=disnake.AllowedMentions(roles=False, everyone=False, users=False), chunk_guilds_at_startup = False, test_guilds=[817569246103470110, 1000481119088672898, 1057136078861123725, 1057128362763636899, 913270620840669184, 889177127927296052, 879153808763129917])  #, test_guilds=[817569246103470110, 1000481119088672898, 1057136078861123725, 1057128362763636899, 913270620840669184, 889177127927296052]
        self.bot = self
